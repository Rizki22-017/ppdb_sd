                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namaLengkapAyah"
                                                ...
                                                value="{{ old('nama_lengkap_ayah', $registration->nama_lengkap_ayah ?? '') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namaLengkapIbu"
                                                ...
                                                value="{{ old('nama_lengkap_bu', $registration->nama_lengkap_ibu ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="alamat" name="alamat_ortu"
                                                value="{{ old('alamat_ortu', $registration->alamat_ortu ?? '') }}" required
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="notelp" name="no_telp_ortu"
                                                value="{{ old('no_telp_ortu', $registration->no_telp_ortu ?? '') }}" required
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="kantorAyah"
                                                        name="kantor_ayah"
                                                        value="{{ old('kantor_ayah', $registration->kantor_ayah ?? '') }}"
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="kantorIbu"
                                                        name="kantor_ibu"
                                                        value="{{ old('kantor_ibu', $registration->kantor_ibu ?? '') }}"
                                                        required placeholder="Jl. Sudirman, Kota Padang">
                                                    <span class="error-message"></span> <!-- Ini untuk pesan kesalahan -->
                                                </div>
                                            </div>
                                        ...
                                        <fieldset class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_tempat_tinggal" id="statusTempatTinggal2" value="Sewa"
                                        ...
                                        <div class="row mb-3" style="padding-top: 2rem">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control mt-2" id="inputLainPendidikanIbu"
                                                    name="pendidikan_ibu_lain"
                                                    value="{{ old('pendidikan_ibu_lain', $registration->pendidikan_ibu_lain ?? '') }}"
                                                    placeholder="Sebutkan..." style="display:none;">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control mt-2" id="detailInputAyah"
                                                    name="pekerjaan_ayah_detail"
                                                    value="{{ old('pekerjaan_ayah_detail', $registration->pekerjaan_ayah_detail ?? '') }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control mt-2" id="detailInputIbu"
                                                    name="pekerjaan_ibu_detail"
                                                    value="{{ old('pekerjaan_ibu_detail', $registration->pekerjaan_ibu_detail ?? '') }}"
                                                    placeholder="Masukan detail golongan" style="display: none;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="tel" class="form-control" id="jumlahTanggungan"
                                                    ...
                                                    value="{{ old('jumlah_tanggungan', $registration->jumlah_tanggungan ?? '') }}">
                                                <span class="error-message"></span> <!-- Ini untuk pesan kesalahan -->
                                            </div>
                                        </div>
