    ...
    <main class="main">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-7">
                ...
                <li><a class="nav-link active" data-bs-toggle="pill" href="#about-tab1" aria-selected="true" role="tab">Guru yang berkualitas</a></li>
                <li><a class="nav-link" data-bs-toggle="pill" href="#about-tab2" aria-selected="false" tabindex="-1" role="tab">Fasilitas Lengkap</a></li>
                <li><a class="nav-link" data-bs-toggle="pill" href="#about-tab3" aria-selected="false" tabindex="-1" role="tab">Lingkungan Nyaman</a></li>
                </ul><!-- End Tabs -->
                ...
                <div class="tab-pane fade" id="about-tab3" role="tabpanel">
                    ...
                    <p class="fst-italic">Kami menawarkan lingkungan yang nyaman untuk mendukung proses pembelajaran siswa</p>
