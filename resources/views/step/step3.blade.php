<div class="row">
    ...
    <div class="col-lg-12">
        <div class="d-flex justify-content-between mt-4">
            <button type="button" class="btn btn-secondary btn-prev" data-bs-toggle="tab" data-bs-target="#features-tab-2">Sebelumnya</button>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Berikutnya</button>
        </div>
        <!-- Modal -->
