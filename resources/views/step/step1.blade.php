    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Data Siswa Baru</h5>
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        <div class="mb-3">
                            <h5 class="card-title" for="sekolahAsal">Sebelum Masuk di SD ini berasal dari TK/SD</h5>
                            <div class="container">
                                <div class="mb-3">
                                    <label for="namaSekolah" class="form-label">Nama Sekolah<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="nspnSekolah" class="form-label">NSPN Sekolah<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="alamatSekolah" class="form-label">Alamat Sekolah<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="desaSekolah" class="form-label">Desa<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="kabupatenSekolah" class="form-label">Kabupaten<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="tanggalSKTB" class="form-label">Tanggal SKTB<span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="form-control" id="tanggalSKTB" name="tanggalSKTB">
                                </div>

                                <div class="mb-3">
                                    <label for="nomorSKTB" class="form-label">Nomor SKTB<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="nomorSKTB" name="nomorSKTB"
                                        placeholder="Masukkan nomor SKTB">
                                </div>
                                <div class="mb-3">
                                    <label for="lamaTK" class="form-label">Lama Pendidikan TK<span
                                            class="text-danger">*</span></label>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form>
                        <div class="mb-3">
                            <h5 class="card-title" for="">Jika Murid Pindahan</h5>
                            <div class="container">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="kelas" class="form-label">Masuk SD ini dikelas</label>
                                    <input type="text" class="form-control" id="kelas" name="kelas"
                                        placeholder="Masuk SD ini dikelas">
                                </div>
                            </div>
                        </div>
                    </form><!-- End General Form Elements -->
